...
OUTPUT=/home/lfa81121/blastv1v2/potentialprimers.csv
...
echo CHROM,POS,REF,ALT,AD_REFLOW,AD_ALTLOW,DPLOW,GQLOW,PLLOW,SNPINDEXLOW,AD_REFHIGH,AD_ALTHIGH,DPHIGH,GQHIGH,PLHIGH,SNPINDEXHIGH,REF_FRQ,DELTASNP,NSNPS,TRICUBEDELTASNP,G,GPRIME,PVALUE,NEGLOG10PVAL,QVALUE,MINDP,TRICUBEDP,CL95,CL99,SNPLESS250,SNPPLUS250,COORDS,SNP1,SNP501,SNP27,SNP24,RSNP27,RSNP24 > $OUTPUT
